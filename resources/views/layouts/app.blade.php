...
<body class="h-full">
    ...
    {{-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <!-- Navbar content (links, brand, etc.) -->
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <!-- Optional: Right Side of Navbar (e.g., Authentication Links) -->
            <ul class="navbar-nav">
                <!-- Authentication Links or other links -->
            </ul>
        </div>
    </nav> --}}
...
<div class="min-h-full">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="{{ url('/') }}" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">HomePage</a>
                <a href="{{ route('posts.index') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Posts</a>
                ...
                <a href="{{ route('tags.index') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Tags</a>
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900 text-center">Home Page</h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
